...
export const config = Object.freeze({
  ...
  // ── TLS (optional HTTPS) ──────────────────────────────────────────────────
  // Enable with TLS_ENABLED=1 and certs generated by:
  //   node scripts/gen-https-certs.mjs   (uses bundled mkcert)
  tlsEnabled: /^(1|true|yes)$/i.test(process.env.TLS_ENABLED || ''),
