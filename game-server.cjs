 ...
 *
 * This file is engine-only (no I/O wiring). It used to own `io.on('connection')`
 * registration, which made it impossible to mount under the SaaS socket
 * server (src/backend/realtime/socket.server.js) that already owns the single
 * `io()` instance. `initGameServer(io)` is kept as a thin wrapper for the
 * legacy root server.js; the SaaS server calls `registerGameEngine(io)` instead.
 */
...
// Guards against double-binding the engine's connection handlers when both
// the legacy wrapper (initGameServer) and the SaaS mount path run.
...
// ط·آ·ط¢آ·ط·آ¢ط¢آ£ط·آ·ط¢آ¢ط·آ¢ط¢آ¢ط·آ·ط¢آ£ط·آ¢ط¢آ¢ط·آ£ط¢آ¢ط£آ¢أ¢â€ڑآ¬ط¹â€کط·آ¢ط¢آ¬ط·آ£ط¢آ¢ط£آ¢أ¢â‚¬ع‘ط¢آ¬ط·آ¥أ¢â‚¬â„¢ط·آ·ط¢آ£ط·آ¢ط¢آ¢ط·آ£ط¢آ¢ط£آ¢أ¢â‚¬ع‘ط¢آ¬ط·آ¹أ¢â‚¬ع©ط·آ·ط¢آ¢ط·آ¢ط¢آ¬ط·آ·ط¢آ·ط·آ¢ط¢آ£ط·آ·ط¢آ¢ط·آ¢ط¢آ¢ط·آ·ط¢آ£ط·آ¢ط¢آ¢ط·آ£ط¢آ¢ط£آ¢أ¢â€ڑآ¬ط¹â€کط·آ¢ط¢آ¬ط·آ£ط¢آ¢ط£آ¢أ¢â‚¬ع‘ط¢آ¬ط·آ¥أ¢â‚¬â„¢ط·آ·ط¢آ£ط·آ¢ط¢آ¢ط·آ£ط¢آ¢ط£آ¢أ¢â‚¬ع‘ط¢آ¬ط·آ¹أ¢â‚¬ع©ط·آ·ط¢آ¢ط·آ¢ط¢آ¬ط·آ·ط¢آ·ط·آ¢ط¢آ£ط·آ·ط¢آ¢ط·آ¢ط¢آ¢ط·آ·ط¢آ£ط·آ¢ط¢آ¢ط·آ£ط¢آ¢ط£آ¢أ¢â€ڑآ¬ط¹â€کط·آ¢ط¢آ¬ط·آ£ط¢آ¢ط£آ¢أ¢â‚¬ع‘ط¢آ¬ط·آ¥أ¢â‚¬â„¢ط·آ·ط¢آ£ط·آ¢ط¢آ¢ط·آ£ط¢آ¢ط£آ¢أ¢â‚¬ع‘ط¢آ¬ط·آ¹أ¢â‚¬ع©ط·آ·ط¢آ¢ط·آ¢ط¢آ¬ Broadcast helpers ط·آ·ط¢آ·ط·آ¢ط¢آ£ط·آ·ط¢آ¢ط·آ¢ط¢آ¢ط·آ·ط¢آ£ط·آ¢ط¢آ¢ط·آ£ط¢آ¢ط£آ¢أ¢â€ڑآ¬ط¹â€کط·آ¢ط¢آ¬ط·آ£ط¢آ¢ط£آ¢أ¢â‚¬ع‘ط¢آ¬ط·آ¥أ¢â‚¬â„¢ط·آ·ط¢آ£ط·آ¢ط¢آ¢ط·آ£ط¢آ¢ط£آ¢أ¢â‚¬ع‘ط¢آ¬ط·آ¹أ¢â‚¬ع©ط·آ·ط¢آ¢ط·آ¢ط¢آ¬ط·آ·ط¢آ·ط·آ¢ط¢آ£ط·آ·ط¢آ¢ط·آ¢ط¢آ¢ط·آ·ط¢آ£ط·آ¢ط¢آ¢ط·آ£ط¢آ¢ط£آ¢أ¢â€ڑآ¬ط¹â€کط·آ¢ط¢آ¬ط·آ£ط¢آ¢ط£آ¢أ¢â‚¬ع‘ط¢آ¬ط·آ¥أ¢â‚¬â„¢ط·آ·ط¢آ£ط·آ¢ط¢آ¢ط·آ£ط¢آ¢ط£آ¢أ¢â‚¬ع‘ط¢آ¬ط·آ¹أ¢â‚¬ع©ط·آ·ط¢آ¢ط·آ¢ط¢آ¬ط·آ·ط¢آ·ط·آ¢ط¢آ£ط·آ·ط¢آ¢ط·آ¢ط¢آ¢ط·آ·ط¢آ£ط·آ¢ط¢آ¢ط·آ£ط¢آ¢ط£آ¢أ¢â€ڑآ¬ط¹â€کط·آ¢ط¢آ¬ط·آ£ط¢آ¢ط£آ¢أ¢â‚¬ع‘ط¢آ¬ط·آ¥أ¢â‚¬â„¢ط·آ·ط¢آ£ط·آ¢ط¢آ¢ط·آ£ط¢آ¢ط£آ¢أ¢â‚¬ع‘ط¢آ¬ط·آ¹أ¢â‚¬ع©ط·آ·ط¢آ¢ط·آ¢ط¢آ¬
	...
	/**
	 * Wipe every in-memory game/lobby (used by the admin "Reset Data" flow so
	 * no stale session survives a database reset). Emits a terminal
	 * game:reset event to each participant socket and drops the whole map.
	 */
	function resetActiveGames() {
		const cleared = activeGames.size;
		try {
			if (_io) {
				_io.sockets.sockets.forEach((sock) => {
					try {
						sock.emit('game:reset', { reason: 'data-reset' });
					} catch (_) {}
				});
			}
		} catch (_) {}
		activeGames.clear();
		try { playerSockets.clear(); } catch (_) {}
		return cleared;
	}
...
function registerGameEngine(io) {
	_io = io;
	...
	io.on('connection', (socket) => {
		...
		socket.on('game:openLobby', ({ gameId, gameData }, ack) => {
			const socketRole = String(socket.data?.user?.role || '').toLowerCase();
			const legacyStaff = socket.role === 'admin' && socket.adminAuthenticated === true;
			if (!legacyStaff && !['admin', 'teacher', 'super_admin'].includes(socketRole)) {
				if (typeof ack === 'function') ack({ error: 'Only a teacher or admin can open a lobby' });
				return;
			}
			...
			game.status = 'open';
			game.openedByRole = socketRole || 'admin';
			game.openedByUserId = String(socket.data?.user?.id || '').trim();
			game.openedAt = nowIso();
			if (!game.session) {
		...
		socket.on('game:start', ({ gameId, gameData = null }, ack) => {
			// The SaaS socket server stamps socket.data.user from the JWT at
			// handshake; the legacy root server stamped socket.role from the
			// `identify` event. Accept either — both prove an admin/teacher
			// is on the other end.
			const isLegacyAdmin =
				socket.role === 'admin' && socket.adminAuthenticated === true;
		...
		socket.on('game:deleteAll', (ack) => {
			...
			// Also emit a discrete game:deletedAll so clients with a non-empty
			// local cache can clear it without having to interpret an empty
			// payload (the union-merge logic in realtime-client.js would keep
			// orphans otherwise).
			io.emit('game:deletedAll', {
				scope: 'global',
		...
		socket.on('game:delete', ({ gameId }, ack) => {
			const existed = activeGames.has(gameId);
			if (existed) {
				const game = getTrackedGame(gameId);
			...
			if (typeof ack === 'function') ack({ ok: true, existed });
			// Broadcast the deletion to every other connected client so they
			// drop the orphan from their local cache. The originating admin
			// already removed it locally, so we skip them via socket.broadcast.
			if (existed) {
				socket.broadcast.emit('game:deleted', {
					gameId,
					scope: 'global',
					deletedAt: new Date().toISOString(),
				});
			...
			if (typeof ack === 'function') {
				...
				activeGames.forEach((game) => {
					...
					if (socket.role === 'admin') {
						...
						const studentId = normalizeUserId(socket.data?.user?.id);
						const joined = Boolean(
							studentId &&
							game.session?.participants?.some((participant) =>
								sameUserId(participant?.userId, studentId),
							),
						);
						const status = String(game.status || '').toLowerCase();
						const lobbyStatus = String(game.session?.status || '').toLowerCase();
						// Students receive staff-opened lobbies and their own active
						// match state only. Draft, stale-open, and unrelated completed
						// games never enter the client cache.
						if (
							!(status === 'open' && (!lobbyStatus || lobbyStatus === 'open')) &&
							!(joined && (status === 'live' || status === 'completed'))
						) {
							return;
						}
						list.push({
	...
	console.log('[GameServer] Game engine registered');
}

// Back-compat wrapper for the legacy root server.js, which still calls
// initGameServer(io). Idempotent: a second registration is ignored so the
// SaaS server mounting the engine never double-binds the handlers.
